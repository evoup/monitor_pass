# Generated by Django 2.1.3 on 2019-03-04 13:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hostname', models.CharField(default='', max_length=128, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.OneToOneField(default='', editable=False, on_delete=django.db.models.deletion.CASCADE, to='auth.Group')),
                ('server_group', models.ManyToManyField(db_table='r_user_group_server_group', to='monitor_web.ServerGroup')),
            ],
            options={
                'db_table': 'user_group',
        ...
        migrations.AddField(
            ...
            name='host_id',
            field=models.ForeignKey(default='', editable=False, on_delete=django.db.models.deletion.CASCADE, to='monitor_web.Server'),
        ),
        migrations.AddField(
            model_name='memory',
            name='server_obj',
        ...
        migrations.AddField(
            ...
            name='creator',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='monitor_web.UserProfile'),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit',
        ...
        migrations.AddField(
            model_name='alert',
            name='send_to',
            field=models.ForeignKey(default='', editable=False, on_delete=django.db.models.deletion.CASCADE, to='monitor_web.UserProfile'),
        ),
    ]
