# Generated by Django 2.1.9 on 2019-10-02 07:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stop_command', models.CharField(blank=True, max_length=4096, null=True, verbose_name='批量命令执行中的命令过滤规则')),
                ('ssh_private_key_dir', models.CharField(blank=True, max_length=512, null=True, verbose_name='ssh私钥路径')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='HistoryStringData',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('monitor_item', models.BigIntegerField(verbose_name='监控项')),
                ('ts', models.IntegerField(verbose_name='时间戳（秒）')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=80, verbose_name='监控项名')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.IntegerField(default=3600, verbose_name='第一阶段结束后到第二阶段的秒数')),
                ('title', models.CharField(max_length=128, verbose_name='简短消息')),
                ('content', models.CharField(max_length=512, verbose_name='简短消息')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('exec_at', models.IntegerField(choices=[(1, '在被监控主机上'), (2, '在监控服务端上')], default=1, verbose_name='在什么地方执行')),
                ('port', models.IntegerField(null=True, verbose_name='运行的端口')),
                ('ssh_username', models.CharField(max_length=128, verbose_name='用户名')),
                ('ssh_password', models.CharField(max_length=128, verbose_name='密码')),
                ('command', models.TextField()),
                ('notification_mode', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='monitor_web.NotificationMode')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('type', models.IntegerField(choices=[(0, '触发器被触发'), (1, '在计划时间段内')], default=0)),
                ('operator', models.IntegerField(default=1, verbose_name='操作符')),
                ('value', models.CharField(max_length=255, verbose_name='值')),
                ('operation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monitor_web.Operation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.IntegerField(verbose_name='发送信息的方式')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('start_step', models.IntegerField(default=1, verbose_name='开始的阶段')),
                ('end_step', models.IntegerField(default=1, verbose_name='结束的阶段')),
                ('inteval', models.IntegerField(default=3600, verbose_name='除了第一阶段的每阶段的间隔秒数')),
                ('run_type', models.IntegerField(choices=[(1, '发送通知'), (2, '执行命令')], default=1, verbose_name='操作类型')),
                ('operation', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='monitor_web.Operation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wechat_id', models.CharField(blank=True, max_length=255, null=True, verbose_name='企业微信id')),
        ...
        migrations.CreateModel(
            name='RelationOperationCommandUser',
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('operation_command', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monitor_web.OperationCommand')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='RelationOperationMessageUser',
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('operation_message', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monitor_web.OperationMessage')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monitor_web.Profile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', web.common.db_fields.TinyIntegerField(choices=[(0, '信息'), (1, '警告'), (2, '严重警告'), (3, '灾难警告')], default=0, null=True, verbose_name='严重等级')),
        ...
        migrations.AddField(
            model_name='relationoperationcommanduser',
            name='server',
        ...
        migrations.AddField(
            ...
            name='operation_step',
            field=models.ForeignKey(default=1, null=True, on_delete=django.db.models.deletion.CASCADE, to='monitor_web.OperationStep'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='historystringdata',
            index=models.Index(fields=['monitor_item', 'ts'], name='history_str_monitor_a81315_idx'),
        ),
        migrations.AddField(
        ...
        migrations.AddIndex(
            model_name='event',
            index=models.Index(fields=['time'], name='event_time_762d48_idx'),
        ),
        migrations.AddField(
            model_name='disk',
            name='server_obj',
