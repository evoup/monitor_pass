# Generated by Django 2.1.9 on 2019-09-10 06:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False)),
                ('diagram', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='monitor_web.Diagram')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(default='', max_length=128, unique=True, verbose_name='opentsdb指标名')),
        ...
        migrations.AddField(
            model_name='event',
            name='trigger',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='monitor_web.Trigger'),
        ),
        migrations.AddField(
            model_name='disk',
            name='server_obj',
