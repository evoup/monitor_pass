...
/*
  ...
  +----------------------------------------------------------------------+
  | Last-Modified: 2017-11-10 17:55:25
  +----------------------------------------------------------------------+
 */
...
define('__MDB_SENDTIMEOUT', '30000');  //30 seconds
define('__MDB_RECVTIMEOUT', '30000');  //30 seconds
/* }}} */
/* {{{ redis server
 */
...
if (!$conf['debug']) {
    ...
    define('__MDB_TAB_DATACOLLECTORS', 'monitor_datacollectors'); //新的data collector表
    define('__MDB_TAB_ITEMS', 'monitor_items'); // 新的items表
...
define('__MAX_MONITOR_TYPES',        7 ); //总计的监控种类
